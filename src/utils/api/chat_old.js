...
function websocketInitChannel() {
    ...
    console.log(localStorage.getItem("chatUsername"), '2222222222222222222')
    return eventChannel(emitter => {
        // init the connection here
        ws.onclose = (err) => {
            console.log(err, 'dddccccccccccccccc')
        }
        ws.onerror = (error) =>{
        ...
        ws.onopen = () => {
            console.log(localStorage.getItem("chatUsername"), '33333333333333333333333333')
...
function* chatLoginSaga(action) {
    try {
        ...
        console.log("🚀 ~ file: chat.js ~ line 310 ~ function*chatLoginSaga ~ res", response)
        if (response.success) {
...
function* setChatLanguageSaga(action) {
    try {
        ...
        console.log(action.payload, 'ttttttttttttttttttt ----------')
...
function* getSellerChatDetailsSaga(action) {
    try {
        ...
        console.log("🚀 ~ file: chat.js ~ line 435 ~ function*getSellerChatDetailsSaga ~ res", action.payload)
